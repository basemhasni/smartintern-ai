    ...
    <main className="min-h-screen bg-canvas px-6 py-10 text-ink">
      <div className="mx-auto flex min-h-[80vh] max-w-md items-center">
        <section className="w-full rounded-stitch border border-line bg-white p-8 shadow-stitch">
          <p className="text-sm font-semibold text-ai">SmartIntern AI</p>
          <h1 className="mt-3 text-3xl font-bold tracking-tight">Creation de profil</h1>
          <p className="mt-2 text-sm text-muted">Page placeholder. Le formulaire complet sera connecte au backend ensuite.</p>
