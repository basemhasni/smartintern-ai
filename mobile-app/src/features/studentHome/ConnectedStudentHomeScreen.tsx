...
export function ConnectedStudentHomeScreen({ navigation }: Props) {
  ...
  return (
    <Screen
      ...
      subtitle="Votre carriere prend forme, une decision a la fois."
    >
      <GlassCard accent style={styles.profile}>
        ...
        <View style={styles.profileText}>
          ...
          <AppBadge label={`Role ${user?.role ?? 'STUDENT'}`} tone="info" />
        </View>
      </GlassCard>

      <GlassCard style={styles.aiCard}>
        <View>
          <Text style={styles.eyebrow}>SCORE DE PREPARATION IA</Text>
          <Text style={styles.score}>82<Text style={styles.scoreUnit}>/100</Text></Text>
          <Text style={styles.muted}>Placeholder IA conserve pour la prochaine etape.</Text>
        </View>
        <View style={styles.sparkle}><Ionicons color={theme.colors.cyan} name="sparkles" size={28} /></View>
      </GlassCard>

      <SectionHeader title="Acces rapides" />
